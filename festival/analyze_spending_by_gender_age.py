...
▸ 단순 수치 나열을 지양하고, 각 수치가 가지는 의미를 축제 맥락에 맞춰 해석할 것  
▸ 예를 들어, 50대(28.07%)와 60대(29.51%)가 소비의 과반을 차지하면 '중장년층이 축제 소비의 핵심 계층으로 확인' 등으로 서술  
▸ 성별 소비비율은 50% 이상일 경우 간단한 해석 포함, 미만일 경우 한 문장 팩트 전달  
▸ 각 문장은 ▸ 기호로 시작하며, 보고서용 문장 흐름으로 자연스럽게 연결  
▸ 전체 문장은 3~5문장 이내  
▸ 모든 수치는 소비비율(%) 기준  
▸ 상위 연령대는 괄호로 비율 표기 (예: 60대(29.51%))  
▸ 부정적 표현은 지양하고, 전략적 해석을 기반으로 작성
