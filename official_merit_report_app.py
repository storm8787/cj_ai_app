...
+ 문단 간의 연결을 고려하여, 성과와 과정이 자연스럽게 이어지도록 서술하십시오.
+ 단순 나열형 문장은 피하고, 구체적인 사례와 실천 방식을 중심으로 풍부하게 서술하십시오.
+ 가능한 한 다양한 표현과 동사를 사용하여, 각 항목이 유사하게 보이지 않도록 하십시오.
+ 예) "추진하였습니다", "확산시켰습니다", "기여하였습니다", "정비하였습니다", "정착시켰습니다" 등
